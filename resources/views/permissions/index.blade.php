  ...
  <div class="bg-white rounded-lg shadow-sm">
    <div class="p-6">
        ...
        <table class="w-full text-sm text-left">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50">
              <td class="px-6 py-4 text-gray-600">{{ $group->id }}</td>
              <td class="px-6 py-4 text-gray-900">{{ $group->name }}</td>
              <td class="px-6 py-4">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $group->status === 'ativo' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                  {{ $group->status }}
                </span>
              </td>
      ...
      <div class="mt-4 flex items-center justify-between text-sm text-gray-600">
        <div>
          Mostrando 1 até {{ count($groups) }} de {{ count($groups) }} registros
        </div>
        <div class="flex items-center gap-2">
