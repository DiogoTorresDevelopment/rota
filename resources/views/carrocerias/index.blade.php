...
<div class="flex flex-col">
  ...
  <div class="flex justify-between items-center mb-6">
    <div>
      ...
      <p class="text-sm text-gray-600">Gerencie e cadastre carrocerias</p>
    </div>

    @if(hasPermission('carrocerias.manage'))
    <a href="{{ route('carrocerias.create') }}" 
  ...
  <div class="bg-white rounded-lg shadow-sm">
    <div class="p-6">
        ...
        <table class="w-full text-sm text-left">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50">
              <td class="px-6 py-4 text-gray-600">{{ $carroceria->id }}</td>
              ...
              <td class="px-6 py-4 text-right">
                @if(hasPermission('carrocerias.view') || hasPermission('carrocerias.manage'))
                ...
                <div id="dropdown-{{ $carroceria->id }}" class="hidden absolute right-0 mt-2 w-44 bg-white rounded-lg shadow-lg border border-gray-100 z-50">
                  <ul class="py-1">
                    @if(hasPermission('carrocerias.view'))
                    <li>
                      <a href="{{ route('carrocerias.show', $carroceria->id) }}" 
                    ...
                    @if(hasPermission('carrocerias.manage'))
                    <li>
                      <a href="{{ route('carrocerias.edit', $carroceria->id) }}" 
                         class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                      <form action="{{ route('carrocerias.destroy', $carroceria->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
      ...
      <div class="mt-4 flex items-center justify-between text-sm text-gray-600">
        <div>
          Mostrando 1 até {{ count($carrocerias) }} de {{ count($carrocerias) }} registros
        </div>
        <div class="flex items-center gap-2">
